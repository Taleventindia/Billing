	...
	.item-row td{min-height:100px;border:1px solid #000!important; vertical-align:middle }
              ...
              <tr class="item-row">
                  <td class="item-name"><div class="delete-wpr">
                      <textarea id="demoB" tabindex="2" onblur="if(this.value=='') this.value='Item';" onfocus="if(this.value=='Item') this.value='';" name="item[]">Item</textarea> 
                      
<!--                      <input id="demoB" style="height:50px" onblur="" onfocus="if(this.value=='Item') this.value='';" name="item[]" size="13">-->
...
<!--                    <input  style="height:50px" onblur="if(this.value=='') this.value='Description';" onfocus="if(this.value=='Description') this.value='';" name='descr[]' size="28">-->
         ...
         <?php 
            ...
            <br>
            <center><input type="submit" id="saveinv" class="btn btn-primary" value="Save Invoice" name="saveinv" /></center>  
            </form>
    </div>
    </div>
