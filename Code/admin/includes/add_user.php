 <?php 
     ...
     $query="INSERT INTO users".
         '(user_firstname, user_lastname, user_role, user_image, username, user_email, user_password)'.   
    "VALUES('". $user_firstname ."', '". $user_lastname ."', '". $user_role ."', '". $user_image ."','". $username ."', '". $user_email ."','". $hashed_password ."') ";
