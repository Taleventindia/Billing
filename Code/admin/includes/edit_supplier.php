...
//        $query="UPDATE suppliers SET firstname= '{$firstname}', lastname= '{$lastname}', phone= '{$phone}', email= '{$email}', address= '{$address}' WHERE supplier_id= {$the_supplier_id} ";     
...
-->
       <div class="input-group">
            <input class="btn btn-primary" type="submit" name="edit_supplier" value="Update supplier">
       </div>
       </form>
